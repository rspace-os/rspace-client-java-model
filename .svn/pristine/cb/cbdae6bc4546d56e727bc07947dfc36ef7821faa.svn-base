...
/**
 * Top level interface for data repository integration. This is loosely an an abstraction over our
...
public interface IRepository {
	 ...
	 * @throws a runtime {@link IllegalStateException} if connection not OK
	 */
